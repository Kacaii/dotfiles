...
local function setup(st, opts)
	...
	local styles = {
		...
		[4] = t.untracked and ui.Style(t.untracked) or ui.Style():fg("#9399b2"),
		[3] = t.ignored and ui.Style(t.ignored) or ui.Style():fg("#585b70"),
	...
	local signs = {
		...
		[4] = t.untracked_sign and t.untracked_sign or "󱀶",
